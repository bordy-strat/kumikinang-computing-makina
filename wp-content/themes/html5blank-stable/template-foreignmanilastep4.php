<?php /* Template Name: Accreditation ForeignManila Step4 Page Template */ get_header(); ?>
    ...
    <div class="w-container">
		<p>
			...
			<ol>
				...
				<?php echo do_shortcode('[wordpress_file_upload uploadid="2" uploadpath="uploads/accreditation/foreignmanila/step4" fitmode="responsive" createpath="true" forcefilename="true" dublicatespolicy="maintain both" uniquepattern="datetimestamp" redirect="true" redirectlink="'.get_site_url().'/accreditation/form/?filename1='.$_GET['filename1'].'&filename2='.$_GET['filename2'].'&filename3='.$_GET['filename3'].'&filename4=%filename%&type=foreignmanila" placements="filename+selectbutton/progressbar/uploadbutton"]');?>
	</div>
<?php get_footer(); ?>
