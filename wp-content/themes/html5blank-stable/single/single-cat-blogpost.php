...
<?php if (have_posts()): while (have_posts()) : the_post(); ?>
	...
	<div class="w-section article-sec">
		<div class="w-container article-container">
			<h1 style="text-align: left;"><?php echo the_title();?></h1>
			<p class="header-p" style="color: black;">
				...
				<?php endif;?>
				<?php if(get_post_custom_values('custom date', get_the_ID())):?>
				<?php echo "on ".date("M. j Y", strtotime(current(get_post_custom_values('custom date', get_the_ID()))))." (Posted ".date("M. j Y",strtotime(get_the_date())).")";?>
				<?php else:?>
	...
	<?php $items = getPostsByCategory("Blog post","publish",-1,0,"date","DESC",get_the_author_ID());?>
