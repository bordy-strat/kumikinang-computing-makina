<?php /* Template Name: Accreditation ForeignManila Step2 Page Template */ get_header(); ?>
	...
	<ol>
		...
		<?php echo do_shortcode('[wordpress_file_upload uploadid="2" uploadpath="uploads/accreditation/foreignmanila/step2" fitmode="responsive" createpath="true" forcefilename="true" dublicatespolicy="maintain both" uniquepattern="datetimestamp" redirect="true" redirectlink="'.get_site_url().'/accreditation/foreignmanila/step3/?filename1='.$_GET['filename'].'&filename2=%filename%" placements="filename+selectbutton/progressbar/uploadbutton"]');?>
	</div>
<?php get_footer(); ?>
